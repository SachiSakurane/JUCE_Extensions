...
namespace JUCE_Extensions
{
    template <
        ...
        typename StateInformationType = void>
    ...
    public:
        ...
        Processor(
            ...
            std::unique_ptr<ProgramType> &&_program = std::make_unique<ProgramType>()) : juce::AudioProcessor{ioLayouts},
    ...
    class Processor<SettingsType, DAWIOType, ProgramType, StateInformationType> : public juce::AudioProcessor
    {
    public:
        using ProcessorType = Processor<
            SettingsType,
        ...
        Processor(
            ...
            std::unique_ptr<StateInformationType> &&_state_infortmation = std::make_unique<StateInformationType>()) : juce::AudioProcessor{ioLayouts},
                                                                                                                      daw_io{std::move(_daw_io)},
                                                                                                                      program{std::move(_program)},
